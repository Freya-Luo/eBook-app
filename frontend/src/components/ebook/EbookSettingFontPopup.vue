  ...
  methods: {
    ...
    setFontFamily(font) {
      ...
      if (font === 'Default') {
        ...
        this.currentBook.rendition.themes.font('Comic Sans MS')
      } else {
        this.currentBook.rendition.themes.font(font)
      }
      /**
       *  this.currentBook.rendition.themes.font(font)
       *  This only cannot work since fonts files are imported by .css file, we need to incoporated these files
       *  into <iframe>.#document.body
       * */
    }
  }
}

...
/**
 * @param {*} key the key in the value (ebook object)
 * @param {*} value the value in the value (ebook object)
 */
export function setBookObject (fileName, key, value) {
    let ebook = getLocalStorage(`${fileName}-info`)
    if (!ebook) {
        ebook = {}
    }
    ebook[key] = value
    setLocalStorage(`${fileName}-info`, ebook)
}
